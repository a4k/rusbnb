        ...
        <SwitchBox>
            {
                login?(
                    <>
                    <CurButton sx={{borderTopLeftRadius: '15px'}} variant="outlined" id="switch-to-login-btn">Вход</CurButton>
                    ...
                    <CurButton sx={{borderTopRightRadius: '15px'}} variant="outlined" id="switch-to-register-btn">Регистрация</CurButton>
                    </>
                    )
            }
